...
#' @param manredestab22 if T, the management reduces the probability of establishment by the indicated proportion; if F, the management reduces the probability of NOT establishing by the indicated proportion
